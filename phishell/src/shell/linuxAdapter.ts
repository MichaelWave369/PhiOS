...
const capabilities: readonly LinuxCapability[] = [
  ...
  { id: "device.control", label: "Device control and driver binding", consequence: "mutating", available: false },
  { id: "history.persist", label: "Persistent observation history", consequence: "mutating", available: false },
  ...
  { id: "device.inspect", label: "Bounded sysfs hardware inventory", consequence: "read", available: true },
  { id: "history.inspect", label: "Session observation history", consequence: "read", available: true },
  { id: "history.canonical.inspect", label: "Governed canonical history projection", consequence: "read", available: true },
  { id: "history.compare", label: "Temporary canonical state comparison", consequence: "read", available: true },
];
  ...
  return {
    ...
    async request(intent) {
      return {
        ...
        effectPerformed: false,
        reason:
          "PhiShell v0.13 records the requested intent but the effect adapter still cannot perform Linux effects.",
      };
    },
  };
}
