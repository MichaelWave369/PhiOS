...
PROFILE_CAPABILITY_PRESETS: dict[str, set[str]] = {
    ...
    PROFILE_OPERATOR: {CAP_READ_STATE, CAP_READ_HISTORY, CAP_READ_OBSERVATORY, CAP_PROMPT_GUIDANCE, CAP_PULSE_ONCE, CAP_AGENT_DISPATCH, CAP_AGENT_KILL, CAP_AGENT_MEMORY_WRITE},
    PROFILE_DEVELOPER: {CAP_READ_STATE, CAP_READ_HISTORY, CAP_READ_OBSERVATORY, CAP_PROMPT_GUIDANCE, CAP_PULSE_ONCE, CAP_AGENT_DISPATCH, CAP_AGENT_KILL, CAP_AGENT_MEMORY_WRITE},
}
